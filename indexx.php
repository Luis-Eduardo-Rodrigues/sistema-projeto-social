...
if (isset($_POST['usuario_c']) || isset($_POST['senha_c'])) {
        ...
        if(strlen($_POST['usuario_c']) == 0){
            ...
            $sql_code = "SELECT * FROM usuario WHERE usuario = '$usuario_c' AND senha = '$senha_c'";
...
<body class="relative">
    ...
    <section class="flex items-center flex-col gap-6 p-4 bg-[#4bac72] absolute top-50 left-150 w-72 hidden" id="modalCoordenador">
        ...
        <form action="" method="post">
            <input type="text" class="w-48 border-1 rounded-md" placeholder="Usuario" name="usuario_c">
        <input type="password" class="w-48 border-1 rounded-md" placeholder="Senha" name="senha_c">
        <select name="" id="">
            <option value="">Escolha sua escola</option>
            <option value="Olavo Bilac">Olavo Bilac</option>
            <option value="Vilebaldo">Vilebaldo</option>
        </select>
        <button type="submit" class="p-2 bg-purple-600 text-white">Entrar</button>
    ...
    <section class="flex items-center flex-col gap-6 p-4 bg-[#4bac72] absolute top-50 left-150 w-72 hidden" id="modalSecretaria">
        ...
        <input type="text" class="w-48 border-1 rounded-md" placeholder="Usuario" name="usuario_s">
        <input type="password" class="w-48 border-1 rounded-md" placeholder="Senha" name="senha_s">
